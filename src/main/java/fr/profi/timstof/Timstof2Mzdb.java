...
//        CommonInstrumentParams ciParams  = new CommonInstrumentParams(-1,new ParamTree());
        ...
        pmList.add(pm);
        softList.add( new Software(indexSoft,"mzDB","0.9.10", new ParamTree()));//VDS TODO remove should not be needed any more (getPwizVersion in mzdnaccess)
...
//                    time_fillPrec = 0;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(convertArgs.mobilityMethod != null && !convertArgs.mobilityMethod.equals(MobilityRepresentationMethod.NONE)) {
